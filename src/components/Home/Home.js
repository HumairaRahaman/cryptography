    ...
    <div className="hero min-h-screen bg-indigo-50 shadow-lg shadow-indigo-300 ">
      <div className="hero-content text-center">
        <div className="max-w-md">
          ...
          <Link to='/encodeDecode' className="btn btn-primary bg-gradient-to-r from-blue-500 via-indigo-400 to-cyan-400 border-0 hover:from-cyan-400 hover:via-indigo-400 hover:to-blue-500">Get Started</Link>
        </div>
      </div>
    </div>
  );
